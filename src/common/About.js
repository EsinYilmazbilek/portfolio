      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-10 mx-auto text-center">
            ...
            <p className="font-secondary paragraph-lg">Following the bootcamp, I worked as a Frontend Engineer at Mercury Labs and volunteered with a non-profit organisation called Code Your Future in London. I relocated to Adelaide in Dec 22 and currently building side projects with Figma and React.</p>
