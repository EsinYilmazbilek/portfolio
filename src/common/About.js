      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-10 mx-auto text-center">
            ...
            <p className="font-secondary paragraph-lg">As a Junior Frontend Developer & UI Designer with background in Product Design, I bring over 8 years of experience managing projects and working in interdisciplinary teams.</p>
            ...
            <p className="font-secondary paragraph-lg">I am inspired to combine my design and coding skills to achieve sustainable outcomes and keen to utilise them in an engaging and collaborative environment as I grow as a developer & designer.</p>
