      ...
      <div className="container">
        <div className="row justify-content-around">
          ...
          <div className="col-lg-12 text-center experience" id="experience">
            <h2 className="background-each-title">Latest Work Experience</h2>
          </div>
        ...
        <div className="col-lg-12 text-center what-else">
          ...
          <p className="what-else-text paragraph-lg">When I am not looking at code, I like to get hands on with making jams, doing pottery, and keeping up to date with science, well-being, and technology. I also like to travel, now more than ever. Next stop: Sicily. Currently reading: Consumed by Aja Barber.</p>
        </div>
